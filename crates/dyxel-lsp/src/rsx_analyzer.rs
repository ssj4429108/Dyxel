    ...
    fn init_builtin_components(&mut self) {
            ...
            ComponentDef {
                ...
                properties: vec![
                    ...
                    PropertyDef {
                        name: "textColor".to_string(),
                        ty: "(u8, u8, u8, u8)".to_string(),
                        documentation: "文字颜色".to_string(),
                        required: false,
                    },
                    PropertyDef {
                        name: "fontSize".to_string(),
                        ty: "f32".to_string(),
                        documentation: "字体大小".to_string(),
                        required: false,
                    },
                    PropertyDef {
                        name: "fontWeight".to_string(),
                    ...
                    PropertyDef {
                        name: "fontFamily".to_string(),
                        ty: "String".to_string(),
                        documentation: "字体家族".to_string(),
                        required: false,
                    },
                    PropertyDef {
                        name: "cornerRadius".to_string(),
                        ty: "f32".to_string(),
                        documentation: "圆角半径".to_string(),
                        required: false,
                    },
                    PropertyDef {
                        ...
                        ty: "()".to_string(),
                        documentation: "是否展开填满宽度".to_string(),
                        required: false,
                    },
                    PropertyDef {
                        name: "disabled".to_string(),
                        ty: "bool".to_string(),
                        documentation: "是否禁用".to_string(),
                        required: false,
                    },
                ],
            },
        ...
        self.components.insert(
            ...
            ComponentDef {
                ...
                module_path: "dyxel_view::flex::Column".to_string(),
                file_path: "crates/dyxel-view/src/flex.rs".to_string(),
                line: 75,
                documentation: "垂直 Flex 容器\n\n子元素垂直排列，支持间距、对齐等高级属性".to_string(),
                properties: vec![
                    PropertyDef {
                        name: "spacing".to_string(),
                        ty: "f32".to_string(),
                        documentation: "子元素之间的间距".to_string(),
                        required: false,
                    },
                    PropertyDef {
                        name: "mainAxisAlignment".to_string(),
                        ty: "MainAxisAlignment".to_string(),
                        documentation: "主轴对齐：Start | End | Center | SpaceBetween | SpaceAround | SpaceEvenly".to_string(),
                        required: false,
                    },
                    PropertyDef {
                        name: "crossAxisAlignment".to_string(),
                        ty: "CrossAxisAlignment".to_string(),
                        documentation: "交叉轴对齐：Start | End | Center | Stretch".to_string(),
                        required: false,
                    },
                    PropertyDef {
                        name: "padding".to_string(),
                        ty: "Padding | f32 | (f32, f32, f32, f32)".to_string(),
                        documentation: "内边距：Padding::all(10.0) 或 (t, r, b, l)".to_string(),
                        required: false,
                    },
                    PropertyDef {
                        name: "width".to_string(),
                        ty: "SizeUnit | f32 | &str".to_string(),
                        documentation: "宽度：\"100%\", 200.0".to_string(),
                        required: false,
                    },
                    PropertyDef {
                        name: "height".to_string(),
                    ...
                    PropertyDef {
                        ...
                        ty: "Color | (u8, u8, u8) | (u8, u8, u8, u8)".to_string(),
                        documentation: "背景色：Color::rgb(r, g, b) 或 Color::rgba(r, g, b, a)".to_string(),
                        required: false,
                    },
                    PropertyDef {
                        name: "cornerRadius".to_string(),
                    ...
                    PropertyDef {
                        name: "clipToBounds".to_string(),
                        ty: "bool".to_string(),
                        documentation: "是否裁剪子元素超出部分".to_string(),
                        required: false,
                    },
                ],
            },
        ...
        self.components.insert(
            ...
            ComponentDef {
                name: "Row".to_string(),
                module_path: "dyxel_view::flex::Row".to_string(),
                file_path: "crates/dyxel-view/src/flex.rs".to_string(),
                line: 236,
                documentation: "水平 Flex 容器\n\n子元素水平排列，支持间距、对齐等高级属性".to_string(),
                properties: vec![
                    PropertyDef {
                        name: "spacing".to_string(),
                        ty: "f32".to_string(),
        ...
        self.components.insert(
            ...
            ComponentDef {
                ...
                module_path: "dyxel_view::flex::Spacer".to_string(),
                file_path: "crates/dyxel-view/src/flex.rs".to_string(),
                line: 397,
                documentation: "弹性空白组件\n\n在 Row/Column 中自动填充剩余空间".to_string(),
                properties: vec![PropertyDef {
                    name: "flex".to_string(),
                    ty: "f32".to_string(),
                    documentation: "弹性系数，默认 1.0".to_string(),
                    required: false,
                }],
            },
        );
        ...
        self.components.insert(
            ...
            ComponentDef {
                ...
                module_path: "dyxel_view::flex::Divider".to_string(),
                file_path: "crates/dyxel-view/src/flex.rs".to_string(),
                line: 421,
                documentation: "分割线组件\n\n水平或垂直分割线，用于分隔内容".to_string(),
                properties: vec![
                    PropertyDef {
                        name: "color".to_string(),
                        ty: "Color | (u8, u8, u8, u8)".to_string(),
                        documentation: "分割线颜色".to_string(),
                        required: false,
                    },
                    PropertyDef {
                        name: "thickness".to_string(),
                        ty: "f32".to_string(),
                        documentation: "分割线粗细".to_string(),
                        required: false,
                    },
                ],
            },
