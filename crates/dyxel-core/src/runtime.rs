    ...
    match opcode {
        ...
        OpCode::GestureDoubleTap => {
            if payload.len() >= 12 {
                ...
                let x = f32::from_le_bytes([payload[4], payload[5], payload[6], payload[7]]);
                let y = f32::from_le_bytes([payload[8], payload[9], payload[10], payload[11]]);
                log::debug!("Host: GestureDoubleTap node={} pos=({:.1},{:.1})", node_id, x, y);
            }
        }
        OpCode::GestureLongPressStart => {
            if payload.len() >= 12 {
                ...
                let x = f32::from_le_bytes([payload[4], payload[5], payload[6], payload[7]]);
                let y = f32::from_le_bytes([payload[8], payload[9], payload[10], payload[11]]);
                log::debug!("Host: GestureLongPressStart node={} pos=({:.1},{:.1})", node_id, x, y);
            }
        }
        OpCode::GestureLongPressEnd => {
            if payload.len() >= 12 {
                ...
                let x = f32::from_le_bytes([payload[4], payload[5], payload[6], payload[7]]);
                let y = f32::from_le_bytes([payload[8], payload[9], payload[10], payload[11]]);
                log::debug!("Host: GestureLongPressEnd node={} pos=({:.1},{:.1})", node_id, x, y);
            }
        }
        OpCode::GesturePanStart => {
            if payload.len() >= 12 {
                ...
                let x = f32::from_le_bytes([payload[4], payload[5], payload[6], payload[7]]);
                let y = f32::from_le_bytes([payload[8], payload[9], payload[10], payload[11]]);
                log::debug!("Host: GesturePanStart node={} pos=({:.1},{:.1})", node_id, x, y);
            }
        }
        OpCode::GesturePanUpdate => {
            if payload.len() >= 20 {
                ...
                let x = f32::from_le_bytes([payload[4], payload[5], payload[6], payload[7]]);
                let y = f32::from_le_bytes([payload[8], payload[9], payload[10], payload[11]]);
                let delta_x = f32::from_le_bytes([payload[12], payload[13], payload[14], payload[15]]);
                let delta_y = f32::from_le_bytes([payload[16], payload[17], payload[18], payload[19]]);
                log::debug!("Host: GesturePanUpdate node={} pos=({:.1},{:.1}) delta=({:.1},{:.1})", 
                    node_id, x, y, delta_x, delta_y);
            }
        }
        OpCode::GesturePanEnd => {
            if payload.len() >= 20 {
                ...
                let x = f32::from_le_bytes([payload[4], payload[5], payload[6], payload[7]]);
                let y = f32::from_le_bytes([payload[8], payload[9], payload[10], payload[11]]);
                let velocity_x = f32::from_le_bytes([payload[12], payload[13], payload[14], payload[15]]);
                let velocity_y = f32::from_le_bytes([payload[16], payload[17], payload[18], payload[19]]);
                log::debug!("Host: GesturePanEnd node={} pos=({:.1},{:.1}) velocity=({:.1},{:.1})", 
                    node_id, x, y, velocity_x, velocity_y);
            }
        }
        ...
        OpCode::UpdateDeviceInfo => {
            if payload.len() >= 28 {
                ...
                let text_scale = f32::from_le_bytes([payload[4], payload[5], payload[6], payload[7]]);
                let width = f32::from_le_bytes([payload[8], payload[9], payload[10], payload[11]]);
                let height = f32::from_le_bytes([payload[12], payload[13], payload[14], payload[15]]);
...
fn process_command_stream_with_tx(
    ...
    while offset < command_data.len() {
        ...
        match op {
            ...
            OpCode::GestureTap | OpCode::GestureDoubleTap | 
            OpCode::GestureLongPressStart | OpCode::GestureLongPressEnd |
            OpCode::GesturePanStart | OpCode::GesturePanUpdate | OpCode::GesturePanEnd |
            OpCode::GestureCancel => {
