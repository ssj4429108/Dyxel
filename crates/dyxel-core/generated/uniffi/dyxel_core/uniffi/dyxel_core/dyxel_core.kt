   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) = uniffiRustCall() { status ->
            ...
            UniffiLib.INSTANCE.ffi_dyxel_core_rustbuffer_alloc(size.toLong(), status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.INSTANCE.ffi_dyxel_core_rustbuffer_free(buf, status)
        }
    }
...
internal interface UniffiLib : Library {
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            loadIndirect<UniffiLib>(componentName = "dyxel_core")
            .also { lib: UniffiLib ->
    ...
    fun ffi_dyxel_core_rust_future_cancel_u8(`handle`: Long,
    ): Unit
    ...
    fun ffi_dyxel_core_rust_future_cancel_i8(`handle`: Long,
    ): Unit
    ...
    fun ffi_dyxel_core_rust_future_cancel_u16(`handle`: Long,
    ): Unit
    ...
    fun ffi_dyxel_core_rust_future_cancel_i16(`handle`: Long,
    ): Unit
    ...
    fun ffi_dyxel_core_rust_future_cancel_u32(`handle`: Long,
    ): Unit
    ...
    fun ffi_dyxel_core_rust_future_cancel_i32(`handle`: Long,
    ): Unit
    ...
    fun ffi_dyxel_core_rust_future_cancel_u64(`handle`: Long,
    ): Unit
    ...
    fun ffi_dyxel_core_rust_future_cancel_i64(`handle`: Long,
    ): Unit
    ...
    fun ffi_dyxel_core_rust_future_cancel_f32(`handle`: Long,
    ): Unit
    ...
    fun ffi_dyxel_core_rust_future_cancel_f64(`handle`: Long,
    ): Unit
    ...
    fun ffi_dyxel_core_rust_future_cancel_pointer(`handle`: Long,
    ): Unit
    ...
    fun ffi_dyxel_core_rust_future_cancel_rust_buffer(`handle`: Long,
    ): Unit
    ...
    fun ffi_dyxel_core_rust_future_cancel_void(`handle`: Long,
    ): Unit
    ...
    fun uniffi_dyxel_core_checksum_method_dyxelhost_is_engine_ready(
    ): Short
    ...
    fun uniffi_dyxel_core_checksum_method_dyxelhost_notify_surface_changed(
    ): Short
...
private fun uniffiCheckContractApiVersion(lib: UniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_dyxel_core_uniffi_contract_version()
...
open class DyxelHost: Disposable, AutoCloseable, DyxelHostInterface {
    ...
    UniffiLib.INSTANCE.uniffi_dyxel_core_fn_constructor_dyxelhost_new(
        _status)
}
    )
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_dyxel_core_fn_free_dyxelhost(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_dyxel_core_fn_clone_dyxelhost(pointer!!, status)
        }
    }
    ...
    callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_dyxel_core_fn_method_dyxelhost_is_engine_ready(
        it, _status)
}
    }
    )
    ...
    callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_dyxel_core_fn_method_dyxelhost_is_initialized(
        it, _status)
}
    }
    )
    ...
    override suspend fun `loadWasm`(`wasmPath`: kotlin.String) {
        return uniffiRustCallAsync(
        callWithPointer { thisPtr ->
            UniffiLib.INSTANCE.uniffi_dyxel_core_fn_method_dyxelhost_load_wasm(
                thisPtr,
 ...
 * @suppress
 */
public object FfiConverterTypeDyxelHost: FfiConverter<DyxelHost, Pointer> {

    override fun lower(value: DyxelHost): Pointer {
        return value.uniffiClonePointer()
    }

    override fun lift(value: Pointer): DyxelHost {
        return DyxelHost(value)
    }

    override fun read(buf: ByteBuffer): DyxelHost {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: DyxelHost) = 8UL

    override fun write(value: DyxelHost, buf: ByteBuffer) {
