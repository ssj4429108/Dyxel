...
// Essential mode: Simplified blend - only SourceOver

// From blend.wgsl - needed for luminance mask
...
fn blend_mix_compose(backdrop: vec4<f32>, src: vec4<f32>, mode: u32) -> vec4<f32> {
    // Essential mode ignores mode, always use SourceOver
...
fn main(
    ...
    while true {
        ...
        switch tag {
            ...
            // Essential mode: CMD_BLUR_RECT removed
            case CMD_LIN_GRAD: {
