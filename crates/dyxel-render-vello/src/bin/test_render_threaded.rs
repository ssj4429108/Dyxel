...
fn main() {
    ...
    let render_thread = std::thread::spawn(move || {
        ...
        let target_texture = device_clone.create_texture(&wgpu::TextureDescriptor {
        ...
        let readback = device_clone.create_buffer(&wgpu::BufferDescriptor {
            label: Some("Readback"),
        ...
        let mut encoder = device_clone.create_command_encoder(&Default::default());
