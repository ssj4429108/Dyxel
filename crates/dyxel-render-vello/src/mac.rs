...
pub struct MacVelloSurfaceState {
...
unsafe impl Send for MacVelloSurfaceState {}
unsafe impl Sync for MacVelloSurfaceState {}

impl SurfaceState for MacVelloSurfaceState {
